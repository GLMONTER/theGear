...
#define dwForceAttack = 0x31CFFB4;
#define dwForceAttack2 = 0x31CFFC0;
#define dwForceBackward = 0x31D0008;
#define dwForceForward = 0x31D0014;
#define dwForceJump = 0x52489B4;
#define dwForceLeft = 0x31CFF90;
#define dwForceRight = 0x31CFF84;
#define dwGameDir = 0x62C7F8;
#define dwGameRulesProxy = 0x52BBCAC;
#define dwGetAllClasses = 0xDAEBE4;
#define dwGlobalVars = 0x58DCE8;
#define dwGlowObjectManager = 0x52E7040;
#define dwInput = 0x51F0038;
#define dwInterfaceLinkList = 0x942A44;
#define dwLocalPlayer = 0xD8722C;
#define dwMouseEnable = 0xD8CDD0;
#define dwMouseEnablePtr = 0xD8CDA0;
#define dwPlayerResource = 0x31CE310;
#define dwRadarBase = 0x51D37CC;
#define dwSensitivity = 0xD8CC6C;
#define dwSensitivityPtr = 0xD8CC40;
#define dwSetClanTag = 0x8A1A0;
#define dwViewMatrix = 0x4D90354;
#define dwWeaponTable = 0x51F0AF8;
#define dwWeaponTableIndex = 0x325C;
#define dwYawPtr = 0xD8CA30;
#define dwZoomSensitivityRatioPtr = 0xD91CD0;
#define dwbSendPackets = 0xD707A;
#define dwppDirect3DDevice9 = 0xA7050;
#define find_hud_element = 0x2874ED20;
#define force_update_spectator_glow = 0x3AE0A2;
#define interface_engine_cvar = 0x3E9EC;
#define is_c4_owner = 0x3BAB60;
#define m_bDormant = 0xED;
#define m_flSpawnTime = 0xA370;
#define m_pStudioHdr = 0x294C;
#define m_pitchClassPtr = 0x51D3A68;
